...
requirements:
  ...
  - class: NetworkAccess
    ...
    networkAccess: true
baseCommand: [dotnet, fsi, "./arc/workflows/QualIQon/FSharpArcCapsule/mainScripts/main_Miscleavages.fsx"]
inputs:
  arcDirectory:
    type: Directory
  directoryPath: 
...
outputs:
  output_Misscleavages:
    type: Directory
    outputBinding:
      glob: ./arc/runs$(inputs.directoryPath)/Results/Misscleavages
